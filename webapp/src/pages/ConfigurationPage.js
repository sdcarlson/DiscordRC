...
const ConfigurationPage = () => {
  const { roleData, setRoleData, channelData, setChannelData } =
    useFormContext();
  ...
  return (
    <Container
      disableGutters={true}
      maxWidth={false}
      sx={{ display: "flex", height: "100%", "flex-wrap": "wrap" }}
    >
      <Box
        sx={{
          display: "flex",
                  ...
                  {roleRows.map((role) => {
                    return (
                      <ToggleButton
                        value={role.id}
                        color="secondary"
                        sx={{ minWidth: "80%", maxWidth: "80%", border: 0 }}
                      >
                        {role.name}
                      </ToggleButton>
                    );
              ...
              <Stack spacing={2} direction="column">
                ...
                >
                  {channelRows.map((channel) => {
                    ...
                    if (channel.type === "voice") icon = <VolumeUp />;
                    ...
                    return (
                      ...
                      >
                        <Box
                          sx={{ left: 0, marginLeft: 5, position: "absolute" }}
                        >
                          {icon}
                        </Box>
                        <Box
      ...
      >
        {roleSelected !== null && (
          <ConfigurationPageRolePermissions
            id={roleSelected}
            setRoleRows={setRoleRows}
          />
        )}
        {channelSelected !== null && (
          <ConfigurationPageChannelPermissions
            id={channelSelected}
        ...
        >
          ...
          >
            ...
            <Button variant="contained" onClick={() => navigate("/end")}>
              {" "}
              Next{" "}
            </Button>
          </Stack>
